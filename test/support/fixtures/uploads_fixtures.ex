defmodule Eirinchan.UploadsFixtures do
  ...
  @heic_fixture_base64 ""
  ...
  def heic_upload_fixture(filename \\ "sample.heic") do
    base =
      Path.join(
        System.tmp_dir!(),
        "eirinchan-upload-heic-#{System.unique_integer([:positive])}-#{Path.basename(filename, ".heic")}"
      )

    heic_path = base <> ".heic"
    File.write!(heic_path, Base.decode64!(@heic_fixture_base64))
