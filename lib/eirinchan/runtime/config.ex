defmodule Eirinchan.Runtime.Config do
  ...
  @default_config %{
    ...
    ip_nulling_flags: 0,
    ban_appeals: true,
    ban_appeals_min_length: 60 * 60 * 6,
    ban_appeals_max: 1,
    ...
    search_limit: 100,
    search_page_size: 25,
    search_max_matches: 5_000,
    search_timeout_ms: 3_000,
  ...
  @deprecated_switch_aliases %{
    ...
    "ipAccessImagelim" => :ipaccess_imagelim,
    "ipAccessImageLim" => :ipaccess_imagelim,
    "ipNulling" => :ip_nulling,
    "ipNullingFlags" => :ip_nulling_flags,
    "banAppeals" => :ban_appeals,
    "banAppealsMinLength" => :ban_appeals_min_length,
    "banAppealsMax" => :ban_appeals_max,
    "antiBumpFlood" => :anti_bump_flood,
    "maxCites" => :max_cites,
    "maxCross" => :max_cross,
    "floodTime" => :flood_time,
    "floodIpCount" => :flood_ip_count,
    "floodTimeIp" => :flood_time_ip,
    "floodTimeSame" => :flood_time_same,
    "floodTimeBrowser" => :flood_time_browser,
    "floodBrowserCount" => :flood_browser_count,
    "floodTimeClient" => :flood_time_client,
    "floodClientCount" => :flood_client_count,
    ...
    "searchMaxMatches" => :search_max_matches,
    ...
    "rejectSampleFilenames" => :reject_sample_filenames,
