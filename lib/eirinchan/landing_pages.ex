defmodule Eirinchan.LandingPages do
  ...
  def public_boards(boards, board_ids, posts_per_day)
      when is_list(boards) and is_list(board_ids) and is_map(posts_per_day) do
    ...
    |> Enum.map(fn board ->
      ...
      ppd = Map.get(posts_per_day, Integer.to_string(board.id), 0)
